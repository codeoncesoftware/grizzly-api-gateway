...
public class APIService {
	...
	public RuntimeResource getResource(String containerId, String resourcePath, String method, String returnType) {
		try {
			StopWatch watch1 = new StopWatch();
			watch1.start("create Resource");
			RuntimeResource runtimeResource = feignDiscovery.getResource(containerId, resourcePath, method, returnType);
			watch1.stop();
			return runtimeResource;
		} catch (Exception e) {
			// e.printStackTrace();
			log.error("Cound not get the resource : container {} resourcePath {}, method {}", containerId, resourcePath,
					method, e);
			return null;
	...
	public RuntimeResource createResource(String containerId, CreateResourceRequest createresourcerequest) {
		StopWatch watch1 = new StopWatch();
		watch1.start("create Resource");
		RuntimeResource runtimeResource = feignDiscovery.createResource(containerId, createresourcerequest);
		watch1.stop();
